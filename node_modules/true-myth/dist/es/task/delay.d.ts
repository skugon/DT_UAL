 ...
 */
export declare function exponential(options?: {
 ...
 */
export declare function fibonacci(options?: {
    /** Initial delay duration in milliseconds. Default is `1`. */
    from: number;
}): Generator<number>;
/**
...
/**
  ...
  integral value using `Math.round`.
 */
export declare function linear(options?: {
 ...
 */
export declare function none(): Generator<number>;
/**
