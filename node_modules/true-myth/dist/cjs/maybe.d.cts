/**
  ...
  @module
 */
import { AnyFunction } from './-private/utils.cjs';
/**
...
declare type AnyMaybe = Maybe<{}>;
declare type SomeMaybe<T> = {
    [IsMaybe]: T;
};
declare type ValueFor<R extends AnyMaybe> = R extends SomeMaybe<infer T> ? T : never;
 ...
 */
export declare function map<T, U extends {}>(mapFn: (t: T) => U): (maybe: Maybe<T>) => Maybe<U>;
/**
  Map over a {@linkcode Maybe} instance: apply the function to the wrapped value
  if the instance is {@linkcode Just}, and return {@linkcode Nothing} if the
  instance is `Nothing`.
...
export declare function andThen<T, R extends AnyMaybe>(thenFn: (t: T) => R, maybe: Maybe<T>): Maybe<ValueFor<R>>;
export declare function andThen<T, U>(thenFn: (t: T) => Maybe<U>): (maybe: Maybe<T>) => Maybe<U>;
export declare function andThen<T, R extends AnyMaybe>(thenFn: (t: T) => R): (maybe: Maybe<T>) => Maybe<ValueFor<R>>;
/**
 ...
 */
export declare function orElse<T, R extends AnyMaybe>(elseFn: () => R, maybe: Maybe<T>): Maybe<ValueFor<R>>;
export declare function orElse<T, R extends AnyMaybe>(elseFn: () => R): (maybe: Maybe<T>) => Maybe<ValueFor<R>>;
/**
 ...
 */
export declare function ap<T, U extends {}>(maybeFn: Maybe<(t: T) => U>, maybe: Maybe<T>): Maybe<T | U>;
export declare function ap<T, U extends {}>(maybeFn: Maybe<(t: T) => U>): (maybe: Maybe<T>) => Maybe<T | U>;
/**
...
export declare type Predicate<T> = (element: T, index: number, array: AnyArray<T>) => boolean;
export declare type NarrowingPredicate<T, U extends T> = (element: T, index: number, array: AnyArray<T>) => element is U;
/** An array or a readonly array. */
export declare type AnyArray<T> = Array<T> | ReadonlyArray<T>;
/**
  ...
  fetch('https://arrays.example.com')
    .then(response => response.cjson() as Response)
    .then(findAtLeast100)
    .then(found => {
      if (found.isJust) {
 ...
 */
export declare function find<T, U extends T>(predicate: NarrowingPredicate<T, U>, array: AnyArray<T>): Maybe<U>;
export declare function find<T, U extends T>(predicate: NarrowingPredicate<T, U>): (array: AnyArray<T>) => Maybe<U>;
export declare function find<T>(predicate: Predicate<T>, array: AnyArray<T>): Maybe<T>;
export declare function find<T>(predicate: Predicate<T>): (array: AnyArray<T>) => Maybe<T>;
/**
 ...
 */
export declare function first<T>(array: AnyArray<T | null | undefined>): Maybe<T>;
/**
  ...
  @param array The array to get the first item from.
 */
export declare function last<T>(array: AnyArray<T | null | undefined>): Maybe<T>;
/**
 ...
 */
export declare function transposeArray<T extends ReadonlyArray<Maybe<unknown>>>(maybes: T): TransposedArray<T>;
export declare type Unwrapped<T> = T extends Maybe<infer U> ? U : T;
export declare type TransposedArray<T extends ReadonlyArray<Maybe<unknown>>> = Array<unknown> extends T ? Maybe<{
...
export declare function get<T extends {
    [key: string]: unknown;
}, K extends keyof T>(key: K, maybeObj: Maybe<T>): Maybe<NonNullable<T[K]>>;
export declare function get<T extends {
    [key: string]: unknown;
}, K extends keyof T>(key: K): (maybeObj: Maybe<T>) => Maybe<NonNullable<T[K]>>;
/**
 ...
 */
export declare function safe<F extends AnyFunction, P extends Parameters<F>, R extends NonNullable<ReturnType<F>>>(fn: F): (...params: P) => Maybe<R>;
/**
  @alias for {@linkcode safe}.
  @deprecated Switch to using {@linkcode safe} instead. This will be removed at
    9.0.
 */
export declare const wrapReturn: typeof safe;
/**
