...
import * as Delay from './task/delay.cjs';
export { Delay };
declare const IsTask: unique symbol;
declare type SomeTask<T, E> = {
    [IsTask]: [T, E];
};
/** @internal */
declare type TypesFor<S extends AnyTask> = S extends SomeTask<infer T, infer E> ? {
    resolution: T;
    rejection: E;
} : never;
/**
...
declare class TaskImpl<T, E> implements PromiseLike<Result<T, E>> {
    ...
    then<A, B>(onSuccess?: (result: Result<T, E>) => A | PromiseLike<A>, onRejected?: (reason: unknown) => B | PromiseLike<B>): PromiseLike<A | B>;
    toString(): string;
    /**
...
/**
  ...
  @internal
 */
export declare type AnyTask = Task<unknown, unknown>;
export declare type TaskTypesFor<A extends readonly AnyTask[]> = [
    {
...
/**
  ...
  @internal
 */
export declare type ResolvesTo<T extends AnyTask> = TypesFor<T>['resolution'];
/**
  The rejection type for a given {@linkcode Task}
  @internal
 */
export declare type RejectsWith<T extends AnyTask> = TypesFor<T>['rejection'];
/**
...
/**
  ...
  @internal
 */
export declare type All<A extends readonly AnyTask[]> = Task<[
    ...TaskTypesFor<A>[0]
...
export declare function all<A extends readonly AnyTask[]>(tasks: readonly [...A]): All<[...A]>;
/**
  @internal
*/
export declare type Settled<A extends readonly AnyTask[]> = {
...
/**
  ...
  @template A The type of the array or tuple of tasks.
 */
export declare function allSettled<A extends readonly AnyTask[]>(tasks: A): Task<Settled<A>, never>;
/**
...
export declare function any<A extends readonly AnyTask[]>(tasks: readonly [...A]): Task<TaskTypesFor<A>[0][number], AggregateRejection<[...TaskTypesFor<A>[1]]>>;
/**
...
export declare function race<A extends readonly AnyTask[]>(tasks: A): Task<TaskTypesFor<A>[0][number], TaskTypesFor<A>[1][number]>;
/**
...
declare type State = (typeof State)[keyof typeof State];
/** Type returned by calling {@linkcode Task.withResolvers} */
export declare type WithResolvers<T, E> = {
    task: Task<T, E>;
...
export declare const tryOr: typeof TaskImpl.tryOr;
/** @inheritdoc Task.tryOrElse */
export declare const tryOrElse: typeof TaskImpl.tryOrElse;
/**
...
/**
  ...
  @template E The type of the rejection reason when the `Task` rejects.
 */
export declare type Task<T, E> = Pending<T, E> | Resolved<T, E> | Rejected<T, E>;
export default Task;
 ...
 */
export declare type Timer = Task<number, never> & Phantom<'Timer'>;
/**
...
export declare const resolve: typeof TaskImpl.resolve;
/** Standalone function version of {@linkcode Task.reject} */
export declare const reject: typeof TaskImpl.reject;
/** Standalone function version of {@linkcode Task.withResolvers} */
export declare const withResolvers: typeof TaskImpl.withResolvers;
/**
...
/**
  ...
  @returns A `Task` which resolves to the resolution value of the promise or
    ...
    invoking `fn`.
*/
export declare function safelyTryOr<T, E>(rejection: E, fn: () => Promise<T>): Task<T, E>;
export declare function safelyTryOr<T, E>(rejection: E): (fn: () => Promise<T>) => Task<T, E>;
/**
  ...
  @returns A `Task` which resolves to the resolution value of the promise or
    ...
    invoking `fn`.
*/
export declare function safelyTryOrElse<T, E>(onError: (reason: unknown) => E, fn: () => PromiseLike<T>): Task<T, E>;
export declare function safelyTryOrElse<T, E>(onError: (reason: unknown) => E): (fn: () => PromiseLike<T>) => Task<T, E>;
/**
  ...
  const toJson = safe((response: Response) => response.cjson() as unknown);
  ...
  @param fn A function to wrap so it never throws an error or produces a
    `Promise` rejection.
*/
export declare function safe<F extends (...params: never[]) => PromiseLike<unknown>, P extends Parameters<F>, R extends Awaited<ReturnType<F>>>(fn: F): (...params: P) => Task<R, unknown>;
/**
...
*/
export declare function safe<F extends (...params: never[]) => PromiseLike<unknown>, P extends Parameters<F>, R extends Awaited<ReturnType<F>>, E>(fn: F, onError: (reason: unknown) => E): (...params: P) => Task<R, E>;
/**
  ...
  @param fn A function to wrap so it never throws an error or produces a
    `Promise` rejection.
*/
export declare function safeNullable<F extends (...params: never[]) => PromiseLike<unknown>, P extends Parameters<F>, R extends Awaited<ReturnType<F>>>(fn: F): (...params: P) => Task<Maybe<NonNullable<R>>, unknown>;
/**
  Given a function which returns a `Promise` and a function to transform thrown
  errors or `Promise` rejections resulting from calling that function, return a
  new function with the same parameters but which returns a {@linkcode Task}.
  ...
  @param onError A function to use to transform the
*/
export declare function safeNullable<F extends (...params: never[]) => PromiseLike<unknown>, P extends Parameters<F>, R extends Awaited<ReturnType<F>>, E>(fn: F, onError: (reason: unknown) => E): (...params: P) => Task<Maybe<NonNullable<R>>, E>;
/**
  ...
  @template E The type of the rejection reason when the `Task` rejects.
 */
export declare function map<T, U, E>(mapFn: (t: T) => U): (task: Task<T, E>) => Task<U, E>;
export declare function map<T, U, E>(mapFn: (t: T) => U, task: Task<T, E>): Task<U, E>;
/**
  Auto-curried, standalone function form of
  ...
  @template E The type of the rejection reason when the `Task` rejects.
 */
export declare function mapRejected<T, E, F>(mapFn: (e: E) => F): (task: Task<T, E>) => Task<T, F>;
export declare function mapRejected<T, E, F>(mapFn: (e: E) => F, task: Task<T, E>): Task<T, F>;
/**
  Auto-curried, standalone function form of
  ...
  @template E The type of the rejection reason when the `Task` rejects.
 */
export declare function and<T, U, E>(andTask: Task<U, E>): (task: Task<T, E>) => Task<U, E>;
export declare function and<T, U, E>(andTask: Task<U, E>, task: Task<T, E>): Task<U, E>;
/**
  Auto-curried, standalone function form of
  ...
  @template E The type of the rejection reason when the `Task` rejects.
 */
export declare function andThen<T, E, R extends AnyTask>(thenFn: (t: T) => R): (task: Task<T, E>) => Task<ResolvesTo<R>, E | RejectsWith<R>>;
export declare function andThen<T, U, E>(thenFn: (t: T) => U): (task: Task<T, E>) => Task<U, E>;
export declare function andThen<T, E, R extends AnyTask>(thenFn: (t: T) => R, task: Task<T, E>): Task<ResolvesTo<R>, E | RejectsWith<R>>;
export declare function andThen<T, U, E>(thenFn: (t: T) => Task<U, E>, task: Task<T, E>): Task<U, E>;
/**
  Auto-curried, standalone function form of
  ...
  @template E The type of the rejection reason when the `Task` rejects.
 */
export declare function or<U, F, T, E>(other: Task<U, F>): (task: Task<T, E>) => Task<T | U, F>;
export declare function or<U, F, T, E>(other: Task<U, F>, task: Task<T, E>): Task<T | U, F>;
/**
  Auto-curried, standalone function form of
  ...
  @template E The type of the rejection reason when the `Task` rejects.
 */
export declare function orElse<T, E, F, U = T>(elseFn: (reason: E) => Task<U, F>): (task: Task<T, E>) => Task<T | U, F>;
export declare function orElse<T, E, R extends AnyTask>(elseFn: (reason: E) => R): (task: Task<T, E>) => Task<T | ResolvesTo<R>, RejectsWith<R>>;
export declare function orElse<T, E, F, U = T>(elseFn: (reason: E) => Task<U, F>, task: Task<T, E>): Task<T | U, F>;
export declare function orElse<T, E, R extends AnyTask>(elseFn: (reason: E) => R, task: Task<T, E>): Task<T | ResolvesTo<R>, RejectsWith<R>>;
/**
  Auto-curried, standalone function form of
  ...
  @template E The type of the rejection reason when the `Task` rejects.
 */
export declare function match<T, E, A>(matcher: Matcher<T, E, A>): (task: Task<T, E>) => Promise<A>;
export declare function match<T, E, A>(matcher: Matcher<T, E, A>, task: Task<T, E>): Promise<A>;
/**
  Auto-curried, standalone function form of
  ...
  @template E The type of the rejection reason when the `Task` rejects.
 */
export declare function timeout<T, E>(timerOrMs: Timer | number): (task: Task<T, E>) => Task<T, E | Timeout>;
export declare function timeout<T, E>(timerOrMs: Timer | number, task: Task<T, E>): Task<T, E | Timeout>;
/**
  ...
  @template E The type of the rejection reason when the `Task` rejects.
 */
export declare function toPromise<T, E>(task: Task<T, E>): Promise<Result<T, E>>;
/**
 ...
 */
export declare function withRetries<T, E>(retryable: (status: RetryStatus) => Task<T, E | StopRetrying> | StopRetrying, strategy?: Delay.Strategy): Task<T, RetryFailed<E>>;
...
/**
  ...
  @param cause The previous cause (often another `Error`) that resulted in
    stopping retries.
 */
export declare function stopRetrying(message: string, cause?: unknown): StopRetrying;
export declare const RETRY_FAILED_NAME = "TrueMyth.Task.RetryFailed";
/**
  ...
  @group Errors
*/
declare class RetryFailed<E> extends Error {
...
export declare function isRetryFailed(error: unknown): error is RetryFailed<unknown>;
