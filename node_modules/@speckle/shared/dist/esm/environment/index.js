...
export const parseFeatureFlags = (input, options) => {
    ...
    const res = parseEnv(input, {
        ...
        FF_LEGACY_FILE_IMPORTS_ENABLED: {
            schema: z.boolean(),
            description: 'Enables the legacy file importer. This proxies file uploads via REST API on the server instead of directly PUTing files to S3 via pre-signed urls.',
            defaults: { _: false }
        },
        FF_ACC_INTEGRATION_ENABLED: {
            schema: z.boolean(),
            description: 'Enables the integration with ACC. This synchronizes models with specified ACC assets.',
            defaults: { _: false }
        },
        ...
        FF_USERS_INVITE_SCOPE_IS_PUBLIC: {
            schema: z.boolean(),
            description: 'Enables Personal Access Tokens (PAT) to be created with users:invite scope. **WARNING** This can be used to spam invitations to any email address. It is not advised to enable this on servers which are open to public account registration or to which untrusted users have been, or can be, invited.',
            defaults: { _: false }
        }
    });
