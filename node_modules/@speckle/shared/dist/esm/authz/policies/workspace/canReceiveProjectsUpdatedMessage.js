 ...
 */
export const canReceiveWorkspaceProjectsUpdatedMessagePolicy = (loaders) => async ({ userId, projectId, workspaceId }) => {
    ...
    if (workspaceRole === Roles.Workspace.Guest && !projectRole) {
        return err(new ProjectNotEnoughPermissionsError('You must be a project member to receive "projects updated" messages about this project'));
    }
    return ok();
};
